...
const MiddleEast = () => {
  ...
  const subCategories = ['All', 'Israel Gaza', 'India-Pakistan', 'Iran', 'Military Actions', 'Khamenei', 'Syria', 'Yemen', 'Lebanon', 'Turkey'];

  const { data: pollsData, isLoading, error } = useQuery(
    ['polls', 'Middle East', selectedSubCategory, searchTerm, currentPage],
    async () => {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Middle East</h1>
          <p className="text-lg text-gray-600 dark:text-gray-400">Conflicts, geopolitics, and regional developments</p>
        </div>
      </div>
            ...
            <div className="flex-1">
              <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  placeholder="Search Middle East polls..."
